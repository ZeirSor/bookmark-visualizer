...
截至 2026-04-30，当前代码已经完成工具栏入口、只读树浏览、书签卡片、标题 / URL 搜索、书签拖拽移动、书签卡片重排、卡片前后新建书签、文件夹右键新建和重命名、文件夹拖拽移动、书签右键编辑 / 移动 / 删除、备注编辑、主题切换、卡片尺寸设置、侧栏宽度设置和会话内操作日志。下面的需求同时保留第一版产品目标和当前实现差异。
