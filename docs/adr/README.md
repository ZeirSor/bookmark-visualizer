...
- [ADR 0011: 使用独立保存小窗口作为主保存入口](0011-use-independent-save-window.md)：已被 ADR 0012 取代，后续又由 ADR 0013 取代。
- [ADR 0012: 使用内容脚本 Save Overlay 作为主保存入口](0012-use-save-overlay-primary-entry.md)：已被 ADR 0013 取代，Save Overlay 代码暂保留到后续 cleanup run。
