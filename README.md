...
- a compact toolbar popup for saving the current page and opening quick management actions;
...
- Use the toolbar popup to save the current webpage as a native browser bookmark.
...
5. Pin the extension if desired, then click the toolbar icon to open the popup.
...
- Click the toolbar icon on a normal webpage to open the popup Save tab.
...
- Use the popup header or Manage tab to open the full workspace.
